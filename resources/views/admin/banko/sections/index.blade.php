...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">اقسام المنتجات</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">اقسام المنتجات</li>
                ...
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td class="text-lg-center">
                                <a href="{{route('sections.show',$category->id)}}" class="btn btn-info">القسم الفرعي</a>
                            </td>
                            <td class="text-lg-center ">
                                <a class='btn btn-info btn-circle' title="تعديل"
                                href="{{ route('sections.edit', $category->id )}}"><i class="fa fa-edit"></i></a>
                                <a class='btn btn-danger btn-circle' title="حذف"
                                onclick="return confirm('هل انت متكد من حذف الخدمه')"
                                href="{{ route('sections.delete' ,$category->id) }}"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>

...
@section('content')
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{url('roles')}}">{{trans('admin.nav_permissions')}}</a>
                </li>
    ...
    <!-- /.card-header -->
    <form action="{{ route('roles.custom.update', $role->id) }}" method="post">
        <div class="row">
            @csrf
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{trans('admin.name')}}" id="name" name="name"
            ...
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                                            ...
                                            <div class="switch">
                                                <label>
                                                    <input type="checkbox" name="permissions[]"
                                                           value="{{$permission->name}}" @php if(in_array($permission->id ,  $rolePermissions)) echo "checked"; @endphp>
                        ...
                        <div class="center">
                            <button type="submit"
                                    class="m-t-10 m-b-20 waves-effect waves-dark btn btn-success btn-md btn-rounded">{{trans('admin.public_Edit')}}</button>
                        </div>
                    </div>
                </div>
            </div>

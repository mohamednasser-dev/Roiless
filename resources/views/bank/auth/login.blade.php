...
<section id="wrapper" class="login-register login-sidebar" style="background-image:url({{ asset('/assets/images/background/login-register.jpg') }});">
    <div class="login-box card">
        <div class="card-body">
            <form class="form-horizontal form-material" id="loginform" method="POST" action="{{route('bank.login.store') }}">
                @csrf
                <a href="javascript:void(0)" class="text-center db">
                    <img src="{{getlogoimage()->logo}}" style="width: 200px; height: 150px;" alt="Home" />
                </a>
